...
constructor(containerSelector: string, events: eventEmitter) - конструктор принимает селектор контейнера, в который вставляются карточки, экземпляр класса eventEmitter
